...
// When loaded in an Electron renderer via a script tag, prefer the web path
// resolution so the companion wasm is fetched next to this script instead of
// being resolved relative to Electron's internal asar.
if (ENVIRONMENT_IS_WEB && typeof document === 'object' && document.currentScript) {
