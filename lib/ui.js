(function ( w, d, PKAE ) {
	...
	function _makeUIMainView ( UI, app ) {
		...
		ttmp.innerHTML = (app.isDesktopApp ? (
			...
			'<div class="pk_empty_copy">Drop audio or a .recwerk project into the editor, open one from your computer, or load the bundled sample to test the RECwerk workflow immediately.</div>' +
			...
			'<div class="pk_empty_copy">This web build is for quick waveform editing, restoration tests, and playback. Open a local audio file or .recwerk project, drop one onto the page, or launch the bundled sample to see the editor in action.</div>' +
			'<div class="pk_empty_actions">' +
